...
const StudentsTable = () => {
    ...
    return (
      <>
        <button
          ...
          className="mx-1 px-3 py-1 rounded transition-colors duration-300 border-solid border-[1px] border-black bg-gray-200 text-black"
  ...
  return (
    <div>
      ...
      <center>
        <button 
          className='border-black border-2 pl-5 pr-5 mt-10 w-30 rounded h-[70px] text-3xl relative hover:bg-gray-300' 
        ...
        <tbody>
          {currentStudents.map((student, index) => (
            <tr key={index} className='hover:bg-gray-300 ease-out'>
              ...
              <td className="text-center">{student.question_ids.join(', ')}</td>
